            ...
            for it, (x, y, img, saliency) in pbar:
                ...
                for i, layout in enumerate(layouts):
                    ...
                    if command["save_image"]:
                        ...
                        cur_img = Image.open(os.path.join('data/img', img_name))
                        layout_img = self.test_dataset.render(layout, cur_img, border=0, W=224, H=224)
                    ...
                    if command["calculate_harmony"]:
                        ...
                        saliency_map = Image.open(os.path.join('../data/saliency', img_name)).resize((CANVAS_SIZE, CANVAS_SIZE))
